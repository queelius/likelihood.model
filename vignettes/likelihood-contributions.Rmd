...
mle.observed <- mle(model.observed, df, rates)
summary(mle.observed)
loglik(model.observed)(df, algebraic.mle::point(mle.observed))
...
H[abs(H) < 1e-3] <- 0
print(H)
hess_loglik(model.observed)(df, algebraic.mle::point(mle.observed))
```
