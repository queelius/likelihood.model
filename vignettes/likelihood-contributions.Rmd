...
dist <- empirical_dist(model.samp(n=5)$t)
expectation(dist, function(x) x)

# this is still incorrect -- do it for a single element
# in the FIM to see if you can get it to work
fim(model.observed)(rates, df) * nrow(df)
```
